...
class QuestionsBrain {
  //by specifying _ we say that it's a private member of the class whose value isn't be able to modified
  ...
  String setQuestionText() => _Question[_questionnumber].questions;
  bool getQuestionAnswers() => _Question[_questionnumber].answers;
}
